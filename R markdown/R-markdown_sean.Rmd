...
#summary(data)
```
```{r missingness and missingness correlation, echo=FALSE}
...
```
```{r skew and correlation plots, echo=FALSE}
...
par(mfrow=c(1,1))
ggcorrplot(cor$r, type = 'upper', p.mat = p.mat, sig.level = 1, lab = TRUE)
